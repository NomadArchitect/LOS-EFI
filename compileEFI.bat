...
gcc -Wall -Werror -m64 -std=c17 -DUNICODE -mabi=ms -ffreestanding -Wl,--oformat=binary -Wno-unused-variable -Wno-unused-but-set-variable -e main -c loader/loader.c -o loader/loader.bin
